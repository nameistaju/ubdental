...
class PHPMailer
{
     ...
     * * `docs/error-log` Output to error log as configured in php.ini
    ...
    protected function edebug($str)
    {
        ...
        if (is_callable($this->Debugoutput) && !in_array($this->Debugoutput, ['docs/error-log', 'html', 'echo'])) {
     ...
     *
     * @see https://www.php.net/manual/en/book.data/mail.php
     *
     * @param string $header The message headers
     * @param string $body   The message body
     *
